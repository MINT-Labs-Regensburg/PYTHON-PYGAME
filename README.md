...
### Software Installation (haben wir hier bereits für dich installiert. Kannst du zu Hause kostenlos runterladen)
...
4. **Cheat-sheets** - Übersicht über die wichtigsten Befehle in [Python cheatsheet](assets/python-cheat-sheet.pdf) und [Pygame cheatsheet](assets/pygame-cheats-heet.pdf). 
...
- **Visual Studio Code Setup** - Machen wir deinen Computer ready zum Coden
- **Erste Schritte:** Variablen, Print-Befehle und einfache Berechnungen
- **Mini-Projekt:** Einen simplen Taschenrechner programmieren. [Beispiel-Code hier](beispiel-programme/taschenrechner.py)


```python
# Dein erster Python Code!
name = input("Wie heißt du? ")
print(f"Hallo {name}! Willkommen im Python Universe! 🌟")
```
...
- **Mini-Projekt:** Ein kleines Ratespiel programmieren. [Beispiel-Code hier](beispiel-programme/ratespiel.py)
